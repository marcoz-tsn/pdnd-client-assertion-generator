...
using Italia.Pdnd.IdentityModel.ClientAssertionGenerator.Middleware;

namespace Italia.Pdnd.IdentityModel.ClientAssertionGenerator.Api;
...
internal class Program
{
  private static void Main(string[] args)
  {
    ...
    // Add configuration Italia.Pdnd.IdentityModel.ClientAssertionGenerator
